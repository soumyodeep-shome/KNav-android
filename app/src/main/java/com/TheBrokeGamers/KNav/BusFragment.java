...
public class BusFragment extends Fragment {
    ...
    private void AddWordsBusNumber() {
        ...
        busNumberAll.add("9");
        busNumberAll.add("ac-1");
        busNumberAll.add("ac-10");
        busNumberAll.add("ac-12");
        busNumberAll.add("ac-12d");
        busNumberAll.add("ac-14");
        busNumberAll.add("ac-15");
        busNumberAll.add("ac-17");
        busNumberAll.add("ac-17b");
        busNumberAll.add("ac-20");
        busNumberAll.add("ac-23a");
        busNumberAll.add("ac-24");
        busNumberAll.add("ac-25");
        busNumberAll.add("ac-3");
        busNumberAll.add("ac-37a");
        busNumberAll.add("ac-37b");
        busNumberAll.add("ac-39");
        busNumberAll.add("ac-4");
        busNumberAll.add("ac-41");
        busNumberAll.add("ac-43");
        busNumberAll.add("ac-44");
        busNumberAll.add("ac-47");
        busNumberAll.add("ac-48");
        busNumberAll.add("ac-49");
        busNumberAll.add("ac-49a");
        busNumberAll.add("ac-4a");
        busNumberAll.add("ac-5");
        busNumberAll.add("ac-50");
        busNumberAll.add("ac-51");
        busNumberAll.add("ac-52");
        busNumberAll.add("ac-53");
        busNumberAll.add("ac-54");
        busNumberAll.add("ac-5d");
        busNumberAll.add("ac-6");
        busNumberAll.add("ac-6a");
        busNumberAll.add("ac-9");
        busNumberAll.add("ac-9a");
        busNumberAll.add("ac-9b");
