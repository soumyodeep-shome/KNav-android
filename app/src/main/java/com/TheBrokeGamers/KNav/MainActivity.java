...
public class MainActivity extends AppCompatActivity
    ...
    private static final int MY_PERMISSIONS_REQUEST_MAPS_RECEIVE = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null && !sharedPreferences.getBoolean("showSplash", false)) {
            ...
            if (fragment != null) {
                ...
                fragmentManager.beginTransaction().replace(R.id.flContent, fragment, "SplashFragment").commit();
            }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id != checkItemId) {
            if (id == R.id.nav_home) {
                ...
                share.putExtra(Intent.EXTRA_TEXT, "Check out Kolkata's best transport app! " +
                        "Get metro and local train timings, bus details and more! \n" +
                        "Download it now from - https://play.google.com/store/apps/details?id=com.TheBrokeGamers.KNav");
