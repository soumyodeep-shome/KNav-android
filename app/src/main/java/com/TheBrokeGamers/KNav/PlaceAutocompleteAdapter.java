...
/**
 * Created by soumyodeep on 11/7/2015.
 */
...
public class PlaceAutocompleteAdapter
    ...
    public PlaceAutocompleteAdapter(Context context, GoogleApiClient googleApiClient,
        ...
        super(context, R.layout.autocomplete_listview, android.R.id.text1);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View customView = trainInflater.inflate(R.layout.autocomplete_listview, parent, false);
        ...
        TextView textView1 = (TextView) customView.findViewById(R.id.autoCompleteTopText);
        textView1.setTypeface(fontBold);
        TextView textView2 = (TextView) customView.findViewById(R.id.autoCompleteBottomText);
